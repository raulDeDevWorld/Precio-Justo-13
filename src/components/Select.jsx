...
export default function Select({arr, name, click}) {
    ...
    return (
        ...
        <div 
            className={`relative bg-gray-50 border border-gray-300 text-gray-900 text-[16px] rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-4`} 
            ...
            className={select ? `absolute left-0 top-12 bg-gray-50 outline outline-1 outline-gray-300 text-gray-900 text-[16px] rounded-b-xl focus:ring-blue-500 focus:outline-blue-500 w-full p-3 z-10`: 'hidden' } 
            // className={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
            // dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`} 
            >
                {

...
export default function Button({ theme, styled, click, children }) {
    ...
    switch (theme) {
        case 'Primary':
            return <button
                type="submit"
                className="text-white bg-vilolet-transparent border border-gray-100 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-xl text-sm w-full sm:w-[250px] px-5 py-3 text-center"
